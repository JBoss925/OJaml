...
| Top-level and nested modules, module-local type declarations, and `open` declarations for built-in and user-defined namespaces | yes | Open Modules, User Modules, Module Types |
